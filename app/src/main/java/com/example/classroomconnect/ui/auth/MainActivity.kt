...
import com.example.classroomconnect.ui.student.StudentActivity
import com.example.classroomconnect.ui.teacher.TeacherActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirebaseMessaging.getInstance().token.addOnCompleteListener { task ->
            if (task.isSuccessful) {
                Log.d("FCM_TOKEN_DEBUG", "Your Token: ${task.result}")
            }
        }

        lifecycleScope.launch {
            val response = repository.generateText("Reply only with: Hello Kunal!")
